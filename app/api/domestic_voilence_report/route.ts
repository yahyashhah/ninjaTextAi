      ...
      messages: [
        {
          ...
          content: `
                ...
                • Incident Description: if any (exract what happened in chronological order)
                • Statements: extract any statements made by involved parties or witnesses.
                • Evidence: if any 
                • Injuries and Damages: if any
                • Resolution: if any (extract the outcome of accident (if any))
